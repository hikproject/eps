  ...
  <div class="navbar-wrapper">
    <div class="m-header d-flex flex-column align-items-center">
      <a href="" class="b-brand text-dark text-center">
        ...
        <img src="../assets/images/Leoco.png" class="img-fluid" style="width: 50px; height: auto;" alt="logo">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"><span class="pc-micon"><i class="ti ti-folder"></i></span><span class="pc-mtext">
              Data Master</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="#!"> <i class="ti ti-users"></i> Customer</a></li>
            <li class="pc-item"><a class="pc-link" href="#!"> <i class="ti ti-barcode"></i> Part</a></li>
            <li class="pc-item"><a class="pc-link" href="#"><i class="ti ti-tools"></i> Kode Jig</a></li>
            <li class="pc-item"><a class="pc-link" href="#"><i class="ti ti-building-warehouse"></i> Kode Plan</a></li>
          </ul>
        </li>
        {{-- end data master --}}
        {{-- PPAM --}}
